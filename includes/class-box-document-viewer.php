    ...
    private static function render_document_page($file_info, $embed_url) {
        ...
        ?>
                ...
                .btn-ai {
                    ...
                    box-shadow: 0 3px 10px rgba(107, 70, 193, 0.35);
                    border: 1px solid rgba(107, 70, 193, 0.1);
                }

                .btn-ai:hover {
                    background: linear-gradient(135deg, #7C3AED 0%, #6D28D9 100%);
                    box-shadow: 0 5px 16px rgba(107, 70, 193, 0.45);
                    transform: translateY(-2px);
                }
                ...
                .box-ai-message-user .box-ai-message-content {
                    ...
                    font-weight: 400;
                    box-shadow:
                        0 4px 12px rgba(0, 113, 227, 0.24),
                ...
                @media (max-width: 480px) {
                    ...
                    /* Modern, comfortable message bubbles */
                    .box-ai-message-user .box-ai-message-content {
                        max-width: 78%;
                        padding: 15px 20px;
                        font-size: 17px;
                    ...
                    /* Apple Dynamic Type inspired sizing */
                    .box-ai-message-content h1 {
                        font-size: 22px;
                        font-weight: 700;
                    ...
                    /* Modern input area - clean and functional */
                    .box-ai-chat-input-container {
                        padding: 20px 22px;
                    ...
                    #box-ai-chat-input:focus {
                        ...
                        transform: none;
                        /* No transform on mobile to prevent layout shift */
                    }

                    /* Large, modern send button */
                    .box-ai-chat-send-btn {
                        padding: 14px;
                        min-width: 52px;
                        min-height: 52px;
                        border-radius: 26px;
                        /* Fully round on mobile */
                        box-shadow:
                ...
                @media (max-width: 360px) {
                    ...
                    /* Maintain comfortable input on small screens */
                    .box-ai-chat-input-container {
                        padding: 16px;
                    ...
                    /* Keep touch targets at minimum 44pt */
                    .box-ai-chat-send-btn {
                        min-width: 44px;
                        min-height: 44px;
                        padding: 10px;
        ...
        <div class="box-document-viewer-wrapper">
            <div class="document-viewer-header">
                ...
                <div class="document-actions">
                    ...
                    <?php endif; ?>
                    <button onclick="goBackToPage();" class="btn btn-secondary" style="display: flex; align-items: center; gap: 6px;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="margin: 0;">
